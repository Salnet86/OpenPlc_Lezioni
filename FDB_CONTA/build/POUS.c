...
void PROGRAM0_init__(PROGRAM0 *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->OT_CV,0,retain)
  __INIT_VAR(data__->IN_PV,5,retain)
...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  __SET_VAR(data__->R_TRIG1.,CLK,,__GET_VAR(data__->BT1,));
  R_TRIG_body__(&data__->R_TRIG1);
  __SET_VAR(data__->CTU0.,CU,,__GET_VAR(data__->R_TRIG1.Q,));
  __SET_VAR(data__->CTU0.,R,,__GET_VAR(data__->RESET,));
  __SET_VAR(data__->CTU0.,PV,,__GET_VAR(data__->IN_PV,));
  CTU_body__(&data__->CTU0);
  __SET_VAR(data__->,LED,,__GET_VAR(data__->CTU0.Q,));
  __SET_VAR(data__->,OT_CV,,__GET_VAR(data__->CTU0.CV,));
