...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  __SET_VAR(data__->TP0.,IN,,__GET_VAR(data__->BT1,));
  __SET_VAR(data__->TP0.,PT,,__time_to_timespec(1, 0, 5, 0, 0, 0));
  TP_body__(&data__->TP0);
  __SET_VAR(data__->SR0.,S1,,__GET_VAR(data__->TP0.Q,));
  __SET_VAR(data__->SR0.,R,,__GET_VAR(data__->BT2,));
  SR_body__(&data__->SR0);
  __SET_VAR(data__->,LED,,__GET_VAR(data__->SR0.Q1,));
